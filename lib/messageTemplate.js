...
exports.customQuestionMessage = function(id, title, imageUrl, qustions, answers) {
  return {
    "type": "flex",
    "altText": "this is a flex message",
    "contents": customFunc(id, title, imageUrl, qustions, answers)
  }
}
...
function customFunc(id, title, imageUrl, qustions, answers) {
  return {
    "type": "bubble",
    "hero": {
      "type": "image",
